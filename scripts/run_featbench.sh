...
export CUSTOM_DATA_PATH="/scratch/spp9399/MaintainableCoder/minisweagent/experiments/data/combined_dataset_with_pr1_stmts_featbench.csv"
mini-extra featbench \
    --subset featbench \
    --split train \
    --output ./results/glm47_first_featbench \
    --config ../src/minisweagent/config/extra/swebench_glm47.yaml \
    --workers 8 \
    --environment-class singularity \
    --path-local-images /scratch/spp9399/dockerImages/featbench \
...
mini-extra featbench \
    ...
    --split test \
    --output ./results/glm47_first_featbench \
    --config ../src/minisweagent/config/extra/swebench_glm47_nonlocal.yaml \
    --workers 8 \
    --environment-class singularity \
    --path-local-images /scratch/spp9399/dockerImages/featbench \
    --task-column-name "PR_1_problem_statement" \
...
FIRST_PR_RESULT_PATH=./results/glm47_first_featbench
...
mini-extra featbench \
    --subset featbench \
    --output ./results/glm47_second_featbench \
    --config ../src/minisweagent/config/extra/swebench_glm47.yaml \
    --split train \
    --workers 8 \
    --environment-class singularity \
...
mini-extra featbench \
    --subset featbench \
    --split test \
    --output ./results/GLM47_Featbench \
    --config ../src/minisweagent/config/extra/swebench_glm47.yaml \
    --workers 16 \
    --environment-class singularity \
    --path-local-images /scratch/spp9399/dockerImages/featbench \
