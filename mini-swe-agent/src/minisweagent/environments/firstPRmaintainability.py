...
@dataclass
class FirstPRMaintainabilityEnvironmentConfig:
    image: str
    cwd: str = "/"
...
class FirstPRMaintainabilityEnvironment:
    def __init__(
        self, *, config_class: type = FirstPRMaintainabilityEnvironmentConfig, logger: logging.Logger | None = None, **kwargs
    ):
        ...
        #     self.execute("git commit -m 'Changes for Maintainability Benchmark'")
