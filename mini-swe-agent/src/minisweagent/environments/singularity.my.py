...
class SingularityEnvironment:
    ...
    def execute(self, command: str, cwd: str = "") -> dict[str, Any]:
        ...
        cmd = [self.config.executable, "exec", "--userns", "-W", os.getenv("APPTAINER_WORKDIR")]
        ...
        cmd.extend(["--writable-tmpfs", str(self.sandbox_dir), "bash", "-c", command])
        try:
            ...
            print('Error in running the cmd:', cmd )
            raise Exception("Error in subprocess.run")
