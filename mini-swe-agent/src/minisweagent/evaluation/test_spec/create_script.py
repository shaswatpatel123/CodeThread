from minisweagent.evaluation.constants import MAP_REPO_TO_EXT
from minisweagent.evaluation.test_spec.javascript import (
    make_eval_script_list_js,
)
from minisweagent.evaluation.test_spec.python import (
    make_repo_script_list_py,
    make_env_script_list_py,
    make_eval_script_list_py,
)
from minisweagent.evaluation.test_spec.utils import (
